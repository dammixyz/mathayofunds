            ...
            <div class="row">
                ...
                <div class="col col-lg-9 col-md-12 col-sm-12 res-m-bttm">
                    <div class="tab-custom">
                        <div class="row no-pt no-mt">
                            <div class="col-md-6 col-md-offset-3">
                                <ul class="nav nav-tabs ucap">
                                    <li class="active"><a href="#buy-giftcard-tab" data-toggle="tab">Account Details</a>
                                    </li>
                        ...
                        <!-- Tab panes -->
                        <div class="tab-content no-pt no-mt" style="padding-right: 0px; padding-left: 0px;">
                                        ...
                                        <form action="{{route('user.update-bank-details')}}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 col-md-offset-2">
                                                    <h5 style="font-family: OpenSans; font-weight: bold">My Bank
                                                        Details</h5>
                                                    <div class="clearfix">
                                                        <div id="bank_details">
                                                            <div class="form-field form-m-bttm">
                                                                ...
                                                                <input name="bank"
                                                                       value="{{$account_details != null ? $account_details->bank : ""}}"
                                                            ...
                                                            <div class="form-field form-m-bttm">
                                                                ...
                                                                <input name="account_no"
                                                                       value="{{$account_details != null ? $account_details->account_number: ""}}"
                                                                       class="form-control required"
                                                                       aria-required="true"
                                                            ...
                                                            <div class="form-field form-m-bttm">
                                                                ...
                                                                <input name="full_name"
                                                                       value="{{$account_details != null ? $account_details->name : ""}}"
                                                                       class="form-control required"
                                                                       aria-required="true"
                                                                       type="text" required>
                                                            </div>
                                                ...
                                                <div class="col-md-8 col-md-offset-2">
                                                    ...
                                                    <div class="clearfix">
                                                        <div id="user_details">
                                                            ...
                                                            <div class="form-field form-m-bttm">
                                                                <label for="phone_number" class="text-sm">Phone
                                                                    Number</label>
