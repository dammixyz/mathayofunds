                            ...
                            <form class="form-signup" action="#" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-field form-m-bttm">
                                        <input name="new_password" type="text" placeholder="New Password *" class="form-control required" aria-required="true" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-field form-m-bttm">
                                        <input name="confirm_password" type="text" placeholder="Confirm New Password *" class="form-control required" aria-required="true" required>
                                    </div>
                                </div>
