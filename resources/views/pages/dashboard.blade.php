...
<div class="features-box section section-pad no-pb pt-15">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                <div class="box round shadow-alt">
                    <h6 class="ucap">Latest Transactions</h6>
                    <p class="small">This table shows your fifty(50) latest trasactions.
                        Check transactions table to view all your transactions with us</p>
                    <div id="latest-transaction-table">
...
<!-- Rates -->
<div class="features-box section section-pad pb-15 pt-15">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                <div class="box round shadow-alt">
                    <h6 class="ucap">Our Coin Rates</h6>
                    <p class="small">This table shows our top ten(10) coin rates. Check the rates page to view all coin rates</p>
            ...
            <div class="col-md-6 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                <div class="box round shadow-alt">
                    ...
                    <p class="small">This table shows our top ten(10) gift card rates. Check the rates page to view all gift card rates</p>
